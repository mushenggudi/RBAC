<template>
<div id="form">
  <el-button id="create" @click="dialogFormVisible = true" size="mini" round>新增学生</el-button>
<div>
  <el-dialog title="新增学生" width="30%" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
    ...
    <el-form >
      <el-form-item label="学生名" :label-width="formLabelWidth">
        <el-input style="width: 80%;" type="textarea" autosize placeholder="输入学生名" v-model="name" autocomplete="off"></el-input>
    </el-form-item>
    </el-form>
    <el-form >
      <el-form-item label="学生年龄" :label-width="formLabelWidth">
        <el-input style="width: 80%;" type="textarea" autosize placeholder="学生年龄" v-model="age" autocomplete="off"></el-input>
    </el-form-item>
    </el-form>
    <el-form >
      <el-form-item label="联系方式" :label-width="formLabelWidth">
        <el-input style="width: 80%;" type="textarea" autosize placeholder="输入联系方式" v-model="phone" autocomplete="off"></el-input>
    </el-form-item>
    </el-form>
...
export default {
  ...
  methods: {
    savelesson () {
      ...
      //           console.log(res)
      //         })
            const table = { name: this.name, age: this.age, phone: this.phone }
